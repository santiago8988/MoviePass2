                            ...
                            foreach($arrayCinemas as $cinema)
                            {
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                        <form action = "<?php echo FRONT_ROOT?>Cinema/Edit" method = "POST"><button class="btn btn-xs btn-secondary active" type = "edit" name = "edit" value = "<?php echo $cinema->getIdCinema(); ?>">Editar</button></form> 
